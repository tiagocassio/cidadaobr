...
RSpec.describe Reference::PublishRelease do
  ...
  it "returns the existing release when checksum is unchanged" do
    first = described_class.call(ledi_version: "6.3.5", sigtap_competence: "202605")
    second = described_class.call(ledi_version: "6.3.5", sigtap_competence: "202605")
  ...
  it "creates platform event and outbox when release is new" do
    expect {
      described_class.call(ledi_version: "6.3.5", sigtap_competence: "202607")
  ...
  it "does not emit platform events when checksum is unchanged" do
    described_class.call(ledi_version: "6.3.5", sigtap_competence: "202608")
...
RSpec.describe Reference::Commands::PublishRelease do
  ...
  it "delegates from the legacy module alias" do
    release = Reference::PublishRelease.call(ledi_version: "6.3.5", sigtap_competence: "202606")
