...
1. **DSL `dsl_v1` para B1–B6 (eSB) e M1–M2 (eMulti)** em `indicator_rules.expression`, com `source_ref` no pack [`lib/indicators/methodology/3493-2024/packs/`](../../lib/indicators/methodology/3493-2024/) sincronizado via `Indicators::MethodologyPackLoader.sync!` (ver ADR-0005).
