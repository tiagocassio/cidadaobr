...
**Snapshot (2026-05-30, gate ADR-0005):** **48 / 53 `done` (~90,6%)** · 4 `partial` · 1 `external` · 0 `todo`
...
| V_SAT | V_SAT | Vinculados | Pesquisa satisfação MS | — | `satisfaction_survey` (`external_only`; sem fallback encounter) | external — import pesquisa MS pendente |
